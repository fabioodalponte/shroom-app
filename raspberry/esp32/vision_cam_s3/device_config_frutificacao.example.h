...
// Clone this file to device_config.h before flashing the frutificacao camera.

static const char *WIFI_SSID = "DALENET_ANDRE_2.4";
static const char *WIFI_PASSWORD = "dalponte1";
static const char *DEVICE_NAME = "vision-cam-frutificacao-01";
static const char *ROOM_NAME = "Frutificacao";
